...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void HandleJump()
    {
        ...
        if (hitHead.collider != null && hitHead.collider.isTrigger == false)
        {
            onGround = true;
        }
        ...
        if (hitFoot.collider != null && hitFoot.collider.isTrigger == false)
        {
            onGround = true;
        }
    ...
    private void checkMove()
    {
        ...
        if (hit1.collider != null && hit1.collider.isTrigger == false)
        {
            canMoveRight = false;
        }
        ...
        if (hitHead1.collider != null && hitHead1.collider.isTrigger == false)
        {
            canMoveRight = false;
        }
        ...
        if (hitFoot1.collider != null && hitFoot1.collider.isTrigger == false)
        {
            canMoveRight = false;
        }
    }
